...
abstract class ParkingPoliceController extends GetxController {

}

class ParkingPoliceControllerImp extends ParkingPoliceController {
  ...
  getAllReservationdata() async {
    ...
    statusRequest = StatusRequest.loading;
    var response = await reservationData.getalldata();
    print("=============================== Controller $response ");
    statusRequest = handlingData(response);
    if (StatusRequest.success == statusRequest) {
      if (response['status'] == "success") {
  ...
  @override
  checkoutreservation(String id) async {
    //  data.clear();
    print("=============================== id $id ");
    print(id);

    statusRequest = StatusRequest.loading;
    var response = await reservationData.ChechoutReservationData(id);
    print("=============================== Controller $response ");
    statusRequest = handlingData(response);
    if (StatusRequest.success == statusRequest) {
      // Start backend
      if (response['status'] == "success") {
        ...
        _navigateTobackScreen('Success', 'The reservation has been checkout successfully');
        getAllReservationdata();
        update();
